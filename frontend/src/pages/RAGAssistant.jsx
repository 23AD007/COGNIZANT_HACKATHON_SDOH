...
function RAGAssistant() {
  ...
  function generateMockResponse(text) {
    ...
    if (
      ...
      return {
        text:
          `${selectedMember.name} has an overall SDOH risk score of ${Math.round(
    ...
    if (
      ...
      return {
        text:
          `The major SDOH factors identified for ${selectedMember.name} include transportation, food access, housing, economic stability, and healthcare access. The relative contribution depends on the available member-level data.`,
        sources: [
          "Member SDOH Profile",
          "SDOH Knowledge Base",
        ],
